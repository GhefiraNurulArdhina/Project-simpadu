...
class ScheduleFactory extends Factory
{
    ...
    {
        return [
            'subject_id' => $this->faker->numberBetween(101, 131),
            'hari' => $this->faker->randomElement(['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat']),
            'jam_mulai' => $this->faker->randomElement(['08:00', '09:00', '10:00', '11:00', '12:00']),
            'jam_selesai' => $this->faker->randomElement(['08:00', '09:00', '10:00', '11:00', '12:00']),
